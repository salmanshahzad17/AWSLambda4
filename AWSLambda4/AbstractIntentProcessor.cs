...
namespace AWSLambda4
{
    public abstract class AbstractIntentProcessor : IIntentProcessor
    {
        ...
        protected string SerializeReservation(ComputerOrder order)
        {
        ...
        protected ComputerOrder DeserializeReservation(string json)
        {
            return JsonConvert.DeserializeObject<ComputerOrder>(json);
        }
        ...
        //public LexResponse Process(LexEvent lexEvent, ILambdaContext context)
        //{
